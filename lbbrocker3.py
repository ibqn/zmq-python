...
# we use tornado library directly by running
# pip install tornado
...
def worker_thread(worker_url, i):
    ...
    # set worker identity
    socket.identity = f"Worker-{i}".encode()
...
def client_thread(client_url, i):
    ...
    socket.identity = f"Client-{i}".encode()
    ...
    def handle_backend(self, msg):
        ...
        if client_addr != b"READY":
            ...
            if self.client_nbr == 0:
                ...
                print('completed all client requests')
